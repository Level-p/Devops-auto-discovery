...
curl -Ls https://download.newrelic.com/install/newrelic-cli/scripts/install.sh | bash && sudo NEW_RELIC_API_KEY=NRAK-ZEH5ZAH6KUXR5MVDHB8BT1DI0FH NEW_RELIC_ACCOUNT_ID=6923103 NEW_RELIC_REGION=EU /usr/local/bin/newrelic install
