...
#  RDS Subnet Group
resource "aws_db_subnet_group" "steven_db_subnet_group" {
...
resource "aws_db_instance" "steven_mysql_database" {
  identifier             = "${var.name}-db"
  db_subnet_group_name   = aws_db_subnet_group.steven_db_subnet_group.name
