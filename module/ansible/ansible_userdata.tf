...
aws s3 cp s3://steven-auto-discovery/ansible-script/prod-bashscript.sh /etc/ansible/prod-bashscript.sh
aws s3 cp s3://steven-auto-discovery/ansible-script/stage-bashscript.sh /etc/ansible/stage-bashscript.sh
aws s3 cp s3://steven-auto-discovery/ansible-script/deployment.yml /etc/ansible/deployment.yml
